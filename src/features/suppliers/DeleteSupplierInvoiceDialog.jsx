// src/features/suppliers/DeleteSupplierInvoiceDialog.jsx
//
// نفس فكرة DeleteJobDialog.jsx بالحرف الواحد، بس لفاتورة مورد بدل عملية
// شغل: بتوضح للمستخدم عدد ومبلغ الدفعات (المعلومات المالية) اللي هتتمسح
// معاها، وبتاخد باسورد حساب الأدمن وتتحقق منه فعليًا (Firebase
// reauthenticate) قبل التنفيذ. الحذف الفعلي (deleteSupplierInvoice) بيمسح
// الفاتورة وكل الدفعات المرتبطة بيها في batch واحد ذرّي — مفيش أي حاجة
// يتيمة بتفضل بعد الحذف.
...
export default DeleteSupplierInvoiceDialog;
